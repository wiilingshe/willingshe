!function() {
    ...
    var c = function(e, t, r) {
        ...
        }), i(this, {onCuepoint: function(e, n) {
    ...
    window.flowplayer = window.$f = function() {
        ...
        },each: n,extend: i}), "function" == typeof jQuery && (jQuery.fn.flowplayer = function(e, n) {
    ...
    window.attachEvent && window.attachEvent("onbeforeunload", function() {
        ...
        if (e) {
    ...
    }, t(window.flashembed, {getVersion: function() {
            var e = [0, 0];
            ...
            return n
        },domReady: s,asString: n,getHTML: o}), u && (jQuery.fn.flashembed = function(e, t) {
        var n = null;
        return this.each(function() {
    ...
    var y = 'video/ogg; codecs="theora, vorbis"', m = 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"', w = 'audio/ogg; codecs="vorbis"', b = "video/webm;", _ = "audio/x-m4a;", E = "audio/mpeg;", S = 'audio/wav; codecs="1"', L = {video: m,audio: E}, P = [m, _, E], C = {video: {ogg: y,ogv: y,avi: m,mp4: m,mkv: m,h264: m,264: m,avc: m,m4v: m,"3gp": m,"3gpp": m,"3g2": m,mpg: m,mpeg: m,webm: b},audio: {ogg: w,oga: w,aac: _,m4a: _,mp3: E,wav: S}};
