...
function initPage()
{
	...
	s("p1").addEventListener("touchstart", function() {if(getID('videoMP4')){getID('videoMP4').play();}else{CreatVid('videoMP4',"video/p1");getID('videoMP4').play();}}, false);
	...
	//	afc("PN1","o",1);
	//},1000);
	s("p1_1btn").addEventListener("touchstart", function() {touch_rot=1; PN();}, false);
   ...
   // p4_1btn
	 ...
	 */
	//p17_1btn
	s("p17_1btn").addEventListener("touchstart", function() {exportRoot.frame_1045(1,1);}, false);
	s("p17_2btn").addEventListener("touchstart", function() {exportRoot.frame_1045(1,2);}, false);
	s("p17_3btn").addEventListener("touchstart", function() {exportRoot.frame_1045(1,3);}, false);
	s("p17_4btn").addEventListener("touchstart", function() {exportRoot.frame_1045(2,1);}, false);
	s("p17_5btn").addEventListener("touchstart", function() {exportRoot.frame_1045(2,2);}, false);
	s("p17_6btn").addEventListener("touchstart", function() {exportRoot.frame_1045(2,3);}, false);
	s("p17_7btn").addEventListener("touchstart", function() {exportRoot.frame_1045(3,1);}, false);
	s("p17_8btn").addEventListener("touchstart", function() {exportRoot.frame_1045(3,2);}, false);
	s("p17_9btn").addEventListener("touchstart", function() {exportRoot.frame_1045(3,3);}, false);
	...
	switch(touch_rot)
	{
		...
		case 2:
			...
			if(PN_pageNum>1){
				window.clearInterval(m18_Staus); 
				PN_pageNum--;
				if(PN_pageNum==1){CreatVid('videoMP4',"video/p1");getID('videoMP4').play();}
				//<img class="imgrsp" src="images/20170809153734.png" style="position:absolute; top:0%; left:0%;width:100%; height:100%;" alt="" />
				//if(PN_pageNum==1){afc('VIDEO1',"i",'<img class="imgrsp" src="images/20170809153734.png" style="position:absolute; top:0%; left:0%;width:100%; height:100%;" alt=""/>');}
				if(PN_pageNum==6){CreatVid3('videoMP4',"video/p7");getID('videoMP4').play();}
				if(PN_pageNum==8){}
				nextpage2("PN",100,TempNum,"Y"); 
				moveContentState();
