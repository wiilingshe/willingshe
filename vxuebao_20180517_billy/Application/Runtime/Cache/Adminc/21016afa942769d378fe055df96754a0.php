       ...
       <form action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm()">
        <div style="text-align: left; padding: 1px; text-align: left;">
            ...
            <table style="vertical-align: top;">
                      <tr>
                    <td >
                       <strong class="btn red-stripe"> 类型                    </td>
                    <td colspan="2"> 
                       <select name="ad[type]"> 
                       <option  name="2" value="2">  首页大图 </option>
                       <option  name="1" value="1">首页LOGO   </option>
                        <option  name="3" value="3"> 场景浏览背景</option>
                         <option  name="4" value="4"> 产品</option>
                         <option name="6" value="6">会员广告图</option>
                        </select>                    </td>
                </tr>
                         <tr>
                    <td style="width: 98px;">文件名                    </td>
                    <td colspan="2">
                          <span class="frm_input_box">
                            <input name="ad[name]" type="text"  id="title"  class="frm_input"  value="<?php echo ($ad["name"]); ?>" /></span>                    </td>
                </tr>
				 <tr>
				   <td style="width: 98px;">排序编号</td>
				   <td colspan="2"><span class="frm_input_box">
                            <input name="ad[sort]" type="text"  id="title"  class="frm_input"  value="<?php echo ($ad["sort"]); ?>" /></span>（数字越大越靠前）</td>
				 </tr>
          <tr>
           <td style="width: 98px;">连接</td>
           <td colspan="2"><span class="frm_input_box">
                            <input name="ad[link]" type="text"  id="title"  class="frm_input"  value="<?php echo ($ad["link"]); ?>" /></span>（产品类,会员广告图填写）</td>
         </tr>
          <tr>
           <td style="width: 98px;">描述</td>
           <td colspan="2"><span class="frm_input_box">
                         
                            <textarea name="ad[descript]" id="title"  class="frm_input"><?php echo ($ad["descript"]); ?></textarea> </span>（产品类，会员广告图填写）</td>
         </tr>
                <tr>
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" >
													<img src="/Uploads/<?php echo ((isset($ad["url"]) && ($ad["url"] !== ""))?($ad["url"]):"default_t.jpg"); ?>"  class="thbnail"  style="max-height: 150px; line-height: 20px;">												</div>
...
<div>
												...
												<a href="#" class="btn fileupload-exists" data-dismiss="fileupload">删除</a>												</div></div></div>
                </tr>
                <tr>
                    <td>                    </td>
                    <td colspan="2">                    </td>
