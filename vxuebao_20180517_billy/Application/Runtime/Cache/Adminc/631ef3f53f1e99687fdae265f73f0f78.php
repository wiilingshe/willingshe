...
<body class="page-header-fixed">
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo U('Lecturer/index');?>">讲师管理</a><i class="icon-angle-right"></i></li>
                </ul>
            </div>
        </div>
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="<?php echo ($ui["lecturer"]); ?>"> <a href="<?php echo U('lecturer/index');?>"> 讲师管理</a> </li>
                <li class="<?php echo ($ui["add_lecturer"]); ?>"> <a href="<?php echo U('lecturer/add');?>"> 添加讲师</a> </li>
            </ul>
            <hr>
        </div>          
        <!--内容-->
        <form action="" method="post">
            <div>
                <label class="left">按讲师名搜索:</label>
                <div>
                    <div>
                        <input name="usname" type="text" class="left"  value="" />
                        <input type="submit" value="搜索" class="left sub" />
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" width="10%">名字</th>
                                <th scope="col" width="25%">头像</th>
                                <th scope="col" width="15%">隶属机构</th> 
                                <th scope="col" width="15%">简介</th>
                                <th scope="col" width="15%">标签</th>                         
                                <th align="center" scope="col" abbr="lbtnOperate" width="15%"><i class="icon-bookmark"></i>操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                                    <td><?php echo ($value["id"]); ?></td>
                                    <td><?php echo ($value["usname"]); ?></td>
                                    <td><img src="<?php echo ($value["photo"]); ?>" width="100px"></td>
                                    <td><?php echo ($value["jigou"]); ?></td>
                                    <td><?php echo ($value["usjianjie"]); ?></td>
                                    <td><?php echo ($value["tags"]); ?></td>
                                     <td align="center" style="width:20px;"> 
                                        <a href="?c=lecturer&a=edit&id=<?php echo ($value["id"]); ?>"class="btn blue"><i class=" icon-edit"> </i>编辑</a>  
                                        <a href="javascript:;" onClick="if(confirm('你确信要删除[<?php echo ($value["usname"]); ?>]吗？')) window.location='?c=lecturer&a=delet&id=<?php echo ($value["id"]); ?>'" class="btn"><i class="icon-remove icon-white"></i> 删除</a>
                                    </div>
                                    </td>
