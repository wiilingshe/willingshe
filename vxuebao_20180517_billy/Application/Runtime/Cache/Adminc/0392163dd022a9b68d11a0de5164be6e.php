...
<li class="<?php echo ($ui["appsystem"]); ?>"> <a href="<?php echo U('Open/appsystem');?>"> APP系统参数设置</a> </li>
       ...
       <form action="" method="post" class="form-horizontal">
            ...
            <table style="vertical-align: top;">
              ...
              <td><input type="text" name="THINK_SDK_QQ[APP_KEY]" value="<?php echo (C("THINK_SDK_QQ.APP_KEY")); ?>" size="45" style="height:30px" /><span>&nbsp;&nbsp;例: 101232445 </span>
            </tr> 
                             
       <tr> 
      <td  height="48" align="right">APP KEY：</td>
      <td><input type="text" name="THINK_SDK_QQ[APP_SECRET]" value="<?php echo (C("THINK_SDK_QQ.APP_SECRET")); ?>" size="45" style="height:30px" /><span>&nbsp;&nbsp;例:dd682e725e85405f772a84f61780feb2   </span>
    </tr> 
       <tr> 
      ...
      <td><input type="text" name="THINK_SDK_QQ[qqqqqq52]" value="<?php echo (C("THINK_SDK_QQ.qqqqqq52")); ?>" size="45" style="height:30px"/>   <span>&nbsp;&nbsp; 例：  </span>
    &lt;meta property=&quot;qc:admins&quot; content=&quot;55532176310052636&quot; /&gt;  则填写：55532176310052636</tr> 
            ...
            <table style="vertical-align: top;">
               <tr> 
              <td  height="48" align="right">APP ID：</td>
              <td><input type="text" name="WX[appid]" value="<?php echo (C("WX.appid")); ?>" size="45" style="height:30px"/><span>&nbsp;&nbsp;例: 101232445 </span>
            </tr> 
                             
       <tr> 
      <td  height="48" align="right">APP KEY：</td>
      <td><input type="text" name="WX[appsecret]" value="<?php echo (C("WX.appsecret")); ?>" size="45" style="height:30px"/><span>&nbsp;&nbsp;例:dd682e725e85405f772a84f61780feb2   </span>
    </tr> 
            </table>
