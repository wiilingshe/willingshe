...
<li class="<?php echo ($ui["appsystem"]); ?>"> <a href="<?php echo U('Open/appsystem');?>"> APP系统参数设置</a> </li>
       ...
       <tr> 
      <td  height="48" align="right"><strong>关闭了的微课：</strong></td>
      <td><input type="text" name="sys_link_arr[close]" value="<?php echo (C("sys_link_arr.close")); ?>" class="ipt" size="45" />
    </tr> 
   
    <tr> 
      <td  height="48" align="right"><strong>正在审核的微课：</strong></td>
      <td><input type="text" name="sys_link_arr[noshenhe]" value="<?php echo (C("sys_link_arr.noshenhe")); ?>" class="ipt" size="45" />
    </tr> 
           <tr> 
      <td  height="48" align="right"><strong>地址失效的微课：</strong></td>
      <td><input type="text" name="sys_link_arr[visit_invalid]" value="<?php echo (C("sys_link_arr.visit_invalid")); ?>" class="ipt" size="45" />
    </tr> 
