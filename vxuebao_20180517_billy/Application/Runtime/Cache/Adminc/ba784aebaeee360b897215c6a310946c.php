                        ...
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="portlet-body form">
                                <div style="margin-left:180px;margin-bottom:20px;">
                                    <a href="<?php echo U('user/upbatch');?>" style="color:#2d1fed;font-size:16px;font-weight:600;">点击下载附件(.csv)</a>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-icon left">
                                            <select name="user" id="parentid">
                                                ...
                                                <?php if(is_array($parent)): foreach($parent as $key=>$value): ?><option value="<?php echo ($value["userid_int"]); ?>" ><?php echo ($value["email_varchar"]); ?> &nbsp;(<?php echo ($value["uname"]); ?>)
