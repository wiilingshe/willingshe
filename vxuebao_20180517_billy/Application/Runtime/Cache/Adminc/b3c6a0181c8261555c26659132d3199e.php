				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">APP系统参数设置</a><i class="icon-angle-right"></i></li>
						</ul>
					</div>
				</div>

				<!-- END PAGE HEADER-->
                <div class="tabbable tabbable-custom tabbable-full-width" style="margin-bottom:0px; padding-bottom:0px">
					<ul class="nav nav-tabs">
					<li class="active"> <a href="<?php echo U('Open/index');?>"> APP系统参数设置</a> </li>
					</ul>
					<hr>
                </div>
				<!-- BEGIN PAGE CONTENT-->          
...
KindEditor.ready(function(K) {
	var uploadbutton = K.uploadbutton({
		...
		fieldName : 'imgFile',
		url : '/Public/kindeditor/php/upload_json.php?dir=file',
...
<form action="<?php echo U('Open/appsystem');?>" method="post" enctype="multipart/form-data"  name="myform"  class="form-horizontal">     
<table style="margin-top:10px">
  <tr>
    <td width="180" height="48" align="right">APP平台名称：</td>
    <td><input name="app_name" type="text" value="<?php echo ($data["app_name"]); ?>" /></td>
  </tr>
  <tr>
    <td height="48" align="right">APP版本号：</td>
    <td><input name="app_view" type="text" value="<?php echo ($data["app_view"]); ?>" /></td>
  </tr>
  <tr>
    <td height="48" align="right">APP升级链接：</td>
    <td><input name="app_link" id="app_link" type="text" value="<?php echo ($data["app_link"]); ?>" style="width:300px"/><input type="button" id="uploadButton" value="Upload" /></td>
  </tr>
  <tr>
    <td></td>
    <td><input name="" type="submit" class="btn blue" value=" 提交 "></td>
  </tr>
</table>
</form>
   </div>
