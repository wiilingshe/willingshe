	...
	<div class="portlet-body" style=" margin-top:15px;">
                            ...
                            <th scope="col" width="3%"><i class="icon-briefcase"></i>ID</th>
                              <th align="center" scope="col" abbr="lbtnOperate" width="15%"><i class="icon-bookmark"></i>操作</th>
                               <th scope="col">名称</th>
                              <th scope="col" width="10%"><i class="icon-question-sign"></i>类型</th>
                            <th scope="col" width="5%"><i class="icon-bookmark"></i>排序</th>
                            <th scope="col" width="15%"><i class="icon-bookmark"></i>缩略图</th>
                            
                            <th scope="col" width="8%"><i class="icon-bookmark"></i>添加时间</th>
                        </tr>
                              ...
                              <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
                                   ...
                                   <td><?php echo ($item["name"]); ?> </td>
                                    ...
                                    <?php case "4": ?>产品<?php break;?>
                                    <?php case "6": ?>会员广告图<?php break;?> 
                                  		<?php default: ?>其它图<?php endswitch;?>
                                  	
                                  	 </td>
                             		 <td><input name="sort" class="sort" value="<?php echo ($item["sort"]); ?>" id="<?php echo ($item["id"]); ?>" style="border:0px; width:60px"/></td>
                                    <td>
