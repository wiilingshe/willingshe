                ...
                <div class="portlet-body" style=" margin-top:15px;">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
                                ...
                                <td align="center" ><!--<a  href="?c=order&a=e&id=<?php echo ($item["id"]); ?>" ><i class="btn black"><i class="icon-edit icon-white"></i></i></a>--> <a  href="javascript:;" onClick="javascript:if (confirm('你确信要删除[<?php echo ($item["title"]); ?>]吗？'))
                            window.location = '?c=order&a=del&id=<?php echo ($item["id"]); ?>&type=<?php echo ($type); ?>'"><i class="btn black"><i class="icon-remove icon-white"></i></i></a>
