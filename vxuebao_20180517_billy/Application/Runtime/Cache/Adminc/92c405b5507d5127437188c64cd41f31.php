...
<link rel="stylesheet" href="/Public/kindeditor4.1.11/themes/default/default.css" />
<style type="text/css">
    ...
    <div class="container-fluid">
        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="<?php echo ($ui["form"]); ?>"> <a href="<?php echo U('Form/index');?>">用户考卷管理</a> </li>
            </ul>
            <hr>
        </div>
        <!-- BEGIN PAGE CONTENT-->          
                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                               ...
                               <div class="controls">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" >
                                            <img src="<?php echo ((isset($form["photo"]) && ($form["photo"] !== ""))?($form["photo"]):'/Uploads/default_t.jpg'); ?>"  class="thbnail"  style="max-height: 150px; line-height: 20px;">
                                        </div>
                                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-height: 150px; line-height: 20px;"></div>
                                        <div>
                                            <span class="btn btn-file"><span class="fileupload-new">上传试卷封面图</span>
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <div class="control-group">
                                    <label class="control-label">考卷标题</label>
                                    <div class="controls">
                                        <div class="input-icon">
                                            <input name="form[title]" type="text"   class="m-wrapt"  value="<?php echo ($form["title"]); ?>" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="form[content]" rows="3" style="width:225px;"  placeholder="请输入考卷描述..."><?php echo ($form["content"]); ?></textarea>
                                    </div> 
                                </div> 
                                 <div class="control-group">
                                    <label class="control-label">类型</label>
                                    <div class="controls">
                                        <select name="form[type]" style="width:80px;">
                                            <?php if(is_array($type)): foreach($type as $key=>$value): if(($key > 0)): ?><option value="<?php echo ($key); ?>" <?php if(($form['type']) == $key): ?>selected<?php endif; ?>><?php echo ($value); ?></option><?php endif; endforeach; endif; ?>
                                        </select>
                                    </div>
                                </div>
                               
                                <div class="control-group">
                                    <label class="control-label">是否为模板</label>
                                    <div class="controls">
                                       <input name="form[istpl]" type="radio" value="1" <?php if(($form['istpl']) == "1"): ?>checked="checked"<?php endif; ?> />是
                                       <input name="form[istpl]" type="radio" value="0" <?php if(($form['istpl']) == "0"): ?>checked="checked"<?php endif; ?> />否
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">是否为热门推荐</label>
                                    <div class="controls">
                                       <input name="form[recommend_int]" type="radio" value="1" <?php if(($form['recommend_int']) == "1"): ?>checked="checked"<?php endif; ?> />是
                                       <input name="form[recommend_int]" type="radio" value="0" <?php if(($form['recommend_int']) == "0"): ?>checked="checked"<?php endif; ?> />否
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <input type="hidden"  name="id" value="<?php echo ($form["id"]); ?>" />
                                    <button type="submit" class="btn blue">确定提交</button>
                                    <button type="button" class="btn give_up">放弃</button>                            
                                </div>
                        </form>
                        <!-- END FORM-->       
                    </div>
...
<!-- END JAVASCRIPTS -->   
<script src="/Public/media/js/nicEdit.js"></script>
<script type="text/javascript">
...
<script src="/Public/kindeditor4.1.11/kindeditor.js"></script>
<script src="/Public/kindeditor4.1.11/lang/zh-CN.js"></script>
<script>
