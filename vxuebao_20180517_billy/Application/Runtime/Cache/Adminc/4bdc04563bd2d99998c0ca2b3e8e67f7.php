...
<div class="container-fluid">
  ...
  <div class="row-fluid">
        ...
        <div style="padding: 1px; width:440px;height:220px;">
            <div id="ctl00_ContentPlaceHolder1_UpdatePanel1">
    <div class="portlet-body" style=" margin-top:15px;">
                       <table class="table table-striped table-bordered table-advance table-hover" style="float:left;">
                          <thead>
                            <tr>
                          ...
                          <?php if(is_array($list)): foreach($list as $key=>$value): ?><tbody>
                                <tr>
                                
                                    <td>
                                    <?php if(($item["filetype_int"]) == "2"): ?><audio src="/view/images/<?php echo ($value["name"]); ?>" controls="controls"></audio> <?php else: ?>  <img src="/assets/images/login/<?php echo ($value["name"]); ?>" class="thbnail"><?php echo ($value["descript"]); ?>广告位<?php endif; ?>     
                                    </td>
                               
                                      <td align="center" style="width:20px; vertical-align: bottom;"> <a href="?c=ad&a=adsense_edit&id=<?php echo ($value["id"]); ?>"class="btn blue"><i class=" icon-edit"> </i>编辑 </a> 
                                        </if>
                                      </div>
                                    </td>          
                                </tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".sort").bind("change",function(){
             var id=$(this).attr('id');
             var num = $(this).val();
             $.get("/adminc.php?s=/Ad/sort.html",{ "id": id, "num": num},function(){window.location.reload();});
        });
