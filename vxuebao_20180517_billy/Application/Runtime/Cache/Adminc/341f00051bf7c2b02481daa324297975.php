    ...
    <div class="row-fluid">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li><a  href="<?php echo U('/Scene/index?flag=sysmb&apply=2');?>" >全部</a></li>
				<li class="active"><a href="<?php echo U('Scene/syspageimport');?>">导入整套模板</a></li>
                <?php if(is_array($scene_type_list)): foreach($scene_type_list as $key=>$item): ?><li><a href="?c=scene&a=index&fnid=<?php echo ($item["value"]); ?>"><?php echo ($item["title"]); ?></a></li><?php endforeach; endif; ?> 
            </ul>
        </div>
			...
			<div class="portlet-body form">     
			   ...
			   <div class="portlet-body form">
			    <div class="control-group" style="margin-top:15px">
					<label class="control-label">选择整套模板ZIP包</label>
					<div class="controls">
