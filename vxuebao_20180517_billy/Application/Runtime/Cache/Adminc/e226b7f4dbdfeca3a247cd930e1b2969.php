    ...
    <div class="row-fluid">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <?php if(($flag) == "useranli"): ?><li><a  href="<?php echo U('/Scene/index/flag/useranli');?>" >全部</a></li>
                ...
                <?php else: ?> 
                <li><a  href="<?php echo U('/scene/pagesys');?>" >全部</a></li>
				<li class="active"><a href="<?php echo U('Scene/syspageimport');?>">导入单页模板</a></li>
                <?php if(is_array($scene_type_list)): foreach($scene_type_list as $key=>$item): ?><li><a href="?c=scene&a=index&fnid=<?php echo ($item["value"]); ?>"><?php echo ($item["title"]); ?></a></li><?php endforeach; endif; endif; ?>
            </ul>
        </div>
			...
			<div class="portlet-body form">     
			   ...
			   <div class="portlet-body form">
			    <div class="control-group" style="margin-top:15px">
					<label class="control-label">选择单页模板ZIP包</label>
					<div class="controls">
						<div class="input-icon left">
							<input name="myfile" type="file"   class="m-wrapt" />(zip或者rar格式)
						</div>
					</div>
				</div>
