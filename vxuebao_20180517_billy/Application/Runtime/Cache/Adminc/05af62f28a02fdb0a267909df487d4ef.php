...
<style type="text/css">
    ...
    .sub{height:30px;background-color:#4d90fe;color:#fff;border:none;}
</style>
</head>
<body class="page-header-fixed">
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo U('Form/index');?>">用户考卷管理</a><i class="icon-angle-right"></i></li>
                </ul>
            </div>
        </div>
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
            	<li class="<?php if(($type) == "0"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 0));?>"> 全部</a> </li>
                <li class="<?php if(($type) == "1"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 1));?>"> 调查</a> </li>
                <li class="<?php if(($type) == "2"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 2));?>"> 考试</a> </li>
                <li class="<?php if(($type) == "3"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 3));?>"> 投票</a> </li>
                <li class="<?php if(($type) == "4"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 4));?>"> 邀请</a> </li>
                <li class="<?php if(($type) == "5"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 5));?>"> 聚会</a> </li>
                <li class="<?php if(($type) == "6"): ?>active<?php endif; ?>"> <a href="<?php echo U('Form/index',array('type' => 6));?>"> 会议</a> </li>
            </ul>
            <hr>
        </div>          
        <!--内容-->
        <form action="" method="post" id="form">
            <div>
                <label class="left">按标题搜索:</label>
                <div>
                    <div>
                        <input name="ipttitle" type="text" class="left"  value="<?php echo ($ipttitle); ?>" />
                        <button type="submit" class="left sub" style=" " id="search">搜索</button>
                    </div>
                </div>
            </div>
            ...
            <div id="ctl00_ContentPlaceHolder1_UpdatePanel1">
                <div class="portlet-body" style=" margin-top:15px;">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        <thead>
                            <tr>
                                <th scope="col" width="5%"><i class="icon-briefcase"></i>ID</th>
                                <th scope="col" width="15%">标题</th>
                                <th scope="col" width="25%">photo</th> 
                                <th scope="col" width="25%">描述</th> 
                                <th scope="col" width="5%">模板</th>                      
                                <th align="center" scope="col" abbr="lbtnOperate" width="25%"><i class="icon-bookmark"></i>操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                                    ...
                                    <td><img src="<?php echo ($value["photo"]); ?>" width="100px"></td>
                                    <td><?php echo ($value["content"]); ?></td>
                                    <td>
                                    	<?php if(($value['istpl']) == "1"): ?>是
                                    	<?php else: ?>
                                    		否<?php endif; ?>
	                                </td>
                                     <td align="center" style="width:20px;"> 
                                        <a href="?c=form&a=edit&id=<?php echo ($value["id"]); ?>"class="btn blue"><i class=" icon-edit"> 
                                        </i>编辑</a>  
                                        <a href="javascript:;" onClick="if(confirm('你确信要删除[<?php echo ($value["title"]); ?>]吗？')) window.location='?c=form&a=delet&id=<?php echo ($value["id"]); ?>'" class="btn"><i class="icon-remove icon-white"></i> 删除</a>
                                    </div>
                                    </td>
                    ...
                    <div class="pages" style="margin:30px 0;float:right;"><?php echo ($page); ?></div>               
                </div>
            </div>
        </div>
        <!--结束-->
...
<script type="text/javascript">
	$('.pages a').click(function(){
		var temHtml = $(this).attr('href');
		$('#form').attr('action',temHtml);
		$('#form').submit();
		return false;
	});
	$('#search').click(function(){
		var temHtml = window.location.href;
		var arr = temHtml.split('/p/');
