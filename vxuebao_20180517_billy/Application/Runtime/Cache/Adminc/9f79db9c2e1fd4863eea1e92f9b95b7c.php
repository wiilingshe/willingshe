                       ...
                       <table class="table table-striped table-bordered table-advance table-hover" style="float:left;">
                          ...
                          <?php if(is_array($list)): foreach($list as $key=>$value): ?><tbody>
                                <tr>
                                    ...
                                    <td>
                                    <?php if(($item["filetype_int"]) == "2"): ?><audio src="/view/images/<?php echo ($value["name"]); ?>" controls="controls"></audio> <?php else: ?>  <img src="/view/images/<?php echo ($value["name"]); ?>" class="thbnail"><?php endif; ?>     
                                    </td>
                               
                                      <td align="center" style="width:20px; vertical-align: bottom;"> <a href="?c=ad&a=bg_edit&id=<?php echo ($value["id"]); ?>"class="btn blue"><i class=" icon-edit"> </i>编辑 </a> 
                                        </if>
                                      </div>
                                    </td>          
                                </tr>
