...
<div class="container-fluid">
      ...
      <td><input type="text" name="home_products_num" value="<?php echo (C("home_products_num")); ?>" <span>&nbsp;&nbsp;例:正在使用微学宝微课制作工具 </span>
    </tr>  
                <tr>
                ...
                <tr>
                    <td height="48" align="right">微学宝邮箱:</td>
                    <td>
                  <input name="wei_email" type="text" value="<?php echo (C("wei_email")); ?>" />
                  <span>&nbsp;&nbsp;例：88888888@qq.com</span>
                    </td>
                </tr>
                 <tr>
                    <td height="48" align="right">微信公众号:</td>
                    <td>
                  <input name="weicode" type="text" value="<?php echo (C("weicode")); ?>" />
                  <span>&nbsp;&nbsp;例：汇思LPT学习与绩效智囊团</span>
                    </td>
                </tr>
                 <tr>
                    <td height="48" align="right">固话:</td>
                    <td>
                  <input name="g_tel" type="text" value="<?php echo (C("g_tel")); ?>" />
                  <span>&nbsp;&nbsp;例：020-88888888</span>
                    </td>
                </tr>
                <tr>
                    <td height="48" align="right">上海办公室固话:</td>
                    <td>
                  <input name="sg_tel" type="text" value="<?php echo (C("sg_tel")); ?>" />
                  <span>&nbsp;&nbsp;例：020-88888888</span>
                    </td>
                </tr>
                 <tr>
                    <td height="48" align="right">微学宝交流群:</td>
                    <td>
                  <input name="wei_qq" type="text" value="<?php echo (C("wei_qq")); ?>" />
                  <span>&nbsp;&nbsp;例：8888888</span>
                    </td>
                </tr>
               ...
               <tr>
                ...
                <tr>
                    <td height="48" align="right">总部联系地址:</td>
                    <td>
                  <input name="A_address" type="text" value="<?php echo (C("A_address")); ?>" />
                  <span>&nbsp;&nbsp;例：广东省广州市天河区</span></td>
                </tr> 				
                 ...
                 <tr>
                    ...
                    <td>
                  <input name="tuijian_pic_url" type="text" value="<?php echo (C("tuijian_pic_url")); ?>" />
                  ...
                  <span>&nbsp;&nbsp;例：：http://e.wesambo.com/#/sample</span></td>
                    ...
                    <td>
                  <input name="your_weixinhao_pic_url" type="text" value="<?php echo (C("your_weixinhao_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/assets/images/help.png'</span></td>
                </tr>  
                  <tr>
                    <td height="48" align="right">优秀案例二维码图片:</td>
                    <td>
                  <input name="your_anli_pic_url" type="text" value="<?php echo (C("your_anli_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/assets/images/help.png'</span></td>
                </tr>
				         <tr>
                    <td height="48" align="right">汇思二维码图片:</td>
                    <td>
                  <input name="your_huisi_pic_url" type="text" value="<?php echo (C("your_huisi_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/assets/images/help.png'</span></td>
                </tr>
