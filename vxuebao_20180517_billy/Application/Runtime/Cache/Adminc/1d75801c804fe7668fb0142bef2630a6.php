                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="" class="form-horizontal" method="post">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="control-group">
                                    <label class="control-label">赠送微币</label>
                                    <div class="controls">
                                        <input type="text" name="user[xd]" class="m-wrap"  value="<?php echo ($user["xd"]); ?>"> 
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">剩余导出次数</label>
                                    <div class="controls">
                                        <input type="text" name="user[export_num]" class="m-wrap"  value="<?php echo ($user["export_num"]); ?>"> 
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo form_select($user_group,$user['type'],'name="user[type]"');?>    
										<span style="margin-left:20px"><input name="user[isad]" type="checkbox" value="1" <?php if(($isad) == "1"): ?>checked="checked"<?php endif; ?>>显示尾页广告(企业用户才生效，其他用户忽略)</span>       
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="radio">
                                            <div class="radio"><span class="checked">
                                                    <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0" type="radio" name="user[checkemail]" value="1" <?php if(($user['checkemail']) == "1"): ?>checked="checked"<?php endif; ?>/><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0">
                                                </span></div>
                                            是
                                        </label>
                                        <label class="radio">
                                            <div class="radio"><span class="">
                                                    <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1" type="radio"   name="user[checkemail]" value="0" <?php if(($user['checkemail']) == "0"): ?>checked="checked"<?php endif; ?>/><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1">
                                                </span></div>
                                            否
                                        </label>  
                                    </div>
