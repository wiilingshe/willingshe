...
class PageController extends Controller{
	...
	public function crop(){		
		...
		$img2=str_replace(substr($src,-4),'_small'.substr($src,-4),$src);
		$image = new \Think\Image(); 
		$image->open($src);	
		$image->crop(I('post.w'),I('post.h'),I('post.x'),I('post.y'))->save($img2);
		$img2=str_replace('D:/vxuebao/Uploads/','',$img2);
		$img2=str_replace('D:/long/Uploads/','',$img2);
