...
class TagController extends BaseController {
    ...
    public function index(){
		...
		$list = $m->field(true)->where($where)->order('create_time desc')->select(); 
	...
	public function e(){
		...
		if(IS_POST){
			...
			$this->success ( '操作成功', '/adminc.php?c=tag&a=e&id='.I('post.id').'&type='.I('post.type') );  //U (  'tag/index' )
