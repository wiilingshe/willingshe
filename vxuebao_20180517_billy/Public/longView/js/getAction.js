	    ...
	    var m, 
	        ...
	        N = function (a, b, c, e) {
	            ...
	            function ba(a, b, c, d) {
	                ...
	                if (pageNum == 1) {
	                    pageMusics[0] ? aud.setAttribute('src', pageMusics[0].url.substr(0,5) == "index" ? pageMusics[0].url.split('index.php')[1] :("Uploads/" + pageMusics[0].url)) : aud.setAttribute('src', "");
	                } else {
	                    pageMusics[pageNum] ? aud.setAttribute('src', pageMusics[pageNum].url.substr(0,5) == "index" ? pageMusics[pageNum].url.split('index.php')[1] :("Uploads/" + pageMusics[pageNum].url)) : aud.setAttribute('src', "");
	                }
