...
!
    ...
    window.eqx = {}, window.eqx.money = {
        config: {
            ...
            resources: [{
                ...
                url: "assets/images/create/money/money_bg.png",
                type: "image"
            }, {
                url: "assets/images/create/money/rmb.png",
                type: "image"
            }, {
                url: "assets/images/create/money/rmb.png",
                type: "image"
                ...
                url: "assets/images/create/money/bag.png",
                type: "image"
            }, {
                url: "assets/images/create/money/rmb.png",
                type: "image"
    ...
    function renderPage() {
        var d, e, f = 1,
            g = $(window).width(),
            h = $(window).height();//千万不能改！！！
        imageWidth = $(".edit_wrapper").width(), imageHeight = $(".edit_wrapper").height();
        g / h >= 320 / 486 ? (f = h / 486, d = (g / f - 320) / 2) : (f = g / 320, e = (h / f - 320) / 2);
        window != window.top && $(".viewer").css({
            width: "100%",
            height: "100%",
            "overflow-x": "hidden",
            "overflow-y": "visible"/*,
            ...
            transform: "scale(" + f + ")",
            overflow: "hidden"
        }), $(".edit_wrapper").css("overflow","visible"))),/*e && $(".edit_area").css({
            marginTop: e
        }),*/ d && $(".edit_area").css({
            marginLeft: d
    ...
    function takeAd(){//页面底部广告
        ...
        $(".edit_area").append(advertisement);
    }
    /**动态生成页面内容**/
    ...
    var param = 0;
    (window.preview || isNewPreviewLocation) && (preview = !0);
    if (!(mobilecheck() || tabletCheck() /*&& window == window.top*/)) {//解决wizbank学习网站ipad打开问题
        var addElmentsForPc = function (a) {
            var b = document.getElementsByTagName("head")[0],
                c = document.createElement("link");//修改大小&修改路径
            c.href = "assets/Css/pcviewer-long.css";
            c.rel = "stylesheet";
            b.appendChild(c);
            $("body").before('<div id="bg" class="bg_white">');
            $("#page1").wrap('<section id="container" class="container main-page"></section>');
            $("#user").wrap('<div id="mainBox-left" style="margin-top: -'+($(window).height() > 750 ? 853 : 672)+'px;"></div>');
            ...
            if(window != window.top){
                ...
                $("body").css({"backgroundImage": "url(view/images/bg_Oly.jpg)","position": "absolute"});
                /* $.getScript("common/js/qrcode.js", function () {
                    $.getScript("longpage/js/jquery.qrcode.min.js", function () {
