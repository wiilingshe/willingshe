...
// $("#tanmubut").bind("touchstart",function(){
//     console.log("手机")
//     tanmuinput();
// });
...
function renderPage(a, b, c) {
    ...
    var d, e, f = 1, 
        g = $(".z-current").width(), 
        h = $(".z-current").height(); 
    imageWidth = $(".m-img").width(), imageHeight = $(".m-img").height(), g / h >= 320 / 486 ? (f = h / 486, d = (g / f - 320) / 2) : (f = g / 320, e = (h / f - 320) / 2), window != window.top && $(".phoneBox .nr").css({
        width: "100%",
        height: "100%",
        overflow: "hidden",
...
function(a) {
        ...
        function b(a, b) {
           ...
           // function resetImg(a) {
            ...
            if (c) {
                ...
                //判断移动端&&修改大小
                if (a.css) {
                    var g = PCcheck() ? (320 * (checkHeight()) - parseInt(a.css.left)) : (320 - a.css.left);
                    /*if (*/
                    e.css({
                        width: PCcheck() ? Math.ceil(parseInt(a.css.width) * (checkHeight())) : a.css.width
                    }), e.css({
                        width: PCcheck() ? Math.ceil(parseInt(a.css.width) * (checkHeight())) : a.css.width,
                        height: PCcheck() ? Math.ceil(parseInt(a.css.height) * (checkHeight())) : a.css.height,
                        left: PCcheck() ? Math.ceil(parseInt(a.css.left) * (checkHeight())) : a.css.left,
                        top: PCcheck() ? Math.ceil(parseInt(a.css.top) * (checkHeight())) : a.css.top,
                        zIndex: a.css.zIndex,
                        bottom: PCcheck() ? Math.ceil(parseInt(a.css.bottom) * (checkHeight())) : a.css.bottom,
                    ...
                    isAndroid() && isWeixin() && 4 == a.type && "0px" != a.css.borderRadius && 0 == a.css.borderWidth && a.properties.anim && (a.css.borderWidth = 1, a.css.borderColor = "rgba(0,0,0,0)"), f.css(a.css).css({
                        ...
                        width: PCcheck() ? Math.round(parseInt(a.css.width) * (checkHeight())) : a.css.width, //修改大小
                        height: PCcheck() ? Math.round(parseInt(a.css.height) * (checkHeight())) : a.css.height
                    ...
                    "i" == ("" + a.type).charAt(0) && "d" != ("" + a.type).charAt(0) && (e.find(".counter-lr").find(".icon").css("line-height", (PCcheck() ? Math.ceil(parseInt(a.css.height) * (checkHeight())) : parseInt(a.css.height)) + "px"))
                }
                return e
            }
        }
        
        function c(a) { //重新调整元素的zIndex值
            ...
            if (i){
                for (i = c(i), f = 0; f < i.length; f++){
                    if (i[f].sceneId = a.sceneId, 3 == i[f].type) {
                        ...
                        if(n[("" + i[f].type).charAt(0)]){
                            n[("" + i[f].type).charAt(0)](k, i[f]);
                            "edit" != e && (g(k, i[f]), g(conli, i[f]) /*触发*/, h(k, i[f]));
                        };
    ...
    i.addInterceptor(function(a, b, c) {
        ...
        if (PCcheck()) { //判断移动端&&修改大小
            if (a.content.indexOf("font-size") >= 0) {
                var content = a.content,
                    re = /font-size/g, // 注意g将全文匹配，不加将永远只返回第一个匹配。 
                    arr;
                while ((arr = re.exec(content)) != null) { //exec使arr返回匹配的第一个，while循环一次将使re在g作用寻找下一个匹配。 
                    var position = arr.index,
                        head = a.content.slice(0, position + 11),
                        fontSize = parseInt(Number(a.content.slice(position + 11, position + 13)) * (checkHeight())),
                        foot = a.content.slice(position + 13);
                    if (!isNaN(fontSize)) {
                        ...
                        for (var i = 0; i < arr.length; i++) {
                            ...
                            fontSize = parseInt(Number(copyFont.string[font]) * (checkHeight()));
                            if (!isNaN(fontSize)) {
            ...
            if (a.content.indexOf("size=") >= 0) {
                var content = a.content,
                    re = /size=/g, // 注意g将全文匹配，不加将永远只返回第一个匹配。 
                    arr;
                while ((arr = re.exec(content)) != null) { //exec使arr返回匹配的第一个，while循环一次将使re在g作用寻找下一个匹配。 
                    var position = arr.index,
                        head, fontSize, foot;
                    if (a.content.slice(position, position + 6) == 'size="') {
                        ...
                        fontSize = parseInt(copyFont.number[Number(a.content.slice(position + 6, position + 7)) - 1] * (checkHeight()));
                        ...
                        var contentText = a.content.slice(position + 6),
                            newposition = a.content.slice(position + 6).indexOf("size=");
                        head = a.content.slice(0, position + newposition + 6)
                        fontSize = parseInt(copyFont.number[Number(contentText.slice(newposition + 6, newposition + 7)) - 1] * (checkHeight()));
            ...
            /*if (a.content.indexOf("line-height") >= 0) {
                var position1 = (a.content).indexOf("line-height"),
                    head1 = a.content.slice(0, position1 + 13),
                    fontSize1 = parseInt(Number(a.content.slice(position1 + 13, position1 + 17)) * (checkHeight())),
                    foot1 = a.content.slice(position1 + 17);
                if (!isNaN(fontSize1)) {
        ...
        if (PCcheck()) { //判断移动端&&修改大小
            ...
            /*if ((a.content).indexOf("line-height") >= 0) {
                ...
                var fontSize1 = parseInt(Number(a.content.slice(position1 + 13, position1 + 17)) * (checkHeight()));
        ...
        var b;
        b = document.createElement("div"), b.id = a.id, b.setAttribute("ctype", a.type), !PCcheck() ? b.setAttribute("class", "element comp_paragraph comp_paragraph1 editable-text") : ($(window).height() > 750 ? b.setAttribute("class", "element comp_paragraph editable-text comp_paragraph5") : b.setAttribute("class", "element comp_paragraph editable-text comp_paragraph3")), a.content && (b.innerHTML = a.content), b.style.cursor = "default";
        /*!PCcheck() ? (b = '<div class="element-box"><div class="element-box-contents" style="width:100%;height:100%"><div id="'+a.id+'" ctype="'+a.type+'" class="element comp_paragraph1 editable-text" style="cursor: default;">'+a.content+'</div></div></div>') : ($(window).height() >750 ? b = '<div class="element-box"><div class="element-box-contents" style="width:100%;height:100%"><div id="'+a.id+'" ctype="'+a.type+'" class="element comp_paragraph comp_paragraph5 editable-text" style="cursor: default;">'+a.content+'</div></div></div>' : b = '<div class="element-box"><div class="element-box-contents" style="width:100%;height:100%"><div id="'+a.id+'" ctype="'+a.type+'" class="element comp_paragraph comp_paragraph3 editable-text" style="cursor: default;">'+a.content+'</div></div></div>')*/
        return b
    ...
    }), i.addComponent("m", function (a) {//创建百度地图img标签
        ...
        if (a.properties.type.indexOf("symbol") < 0) {
            ...
            /*var color = a.properties.items[0].fill;
    ...
    //return b = document.createElement("div"), c = eqxiuSvg.ShapeFromType(a.properties.type, 100, 100, a.id, a.css.color), b = '<svg id="' + a.id + '" class="element svg-element" ctype="' + a.type + '" xmlns="' + eqxiuSvg.NAMESPACE + '" version="1.1" width="100%" height="100%" preserveAspectRatio="xMidYMid" viewBox="' + a.properties.viewBox + '">' + c + "</svg>"
        ...
        return b;
    }), i.addComponent("r", function(a) { //判断移动端&&修改大小--单选框
        ...
        return b.get(0);
    }), i.addComponent("c", function(a) { //判断移动端&&修改大小--多选框
        var b = !PCcheck() ? $('<div class="element comp_radio editable-text comp_radio1" id="' + a.id + '"></div>') : ($(window).height() > 750 ? $('<div class="element comp_radio editable-text comp_radio5" id="' + a.id + '"></div>') : $('<div class="element comp_radio editable-text comp_radio3" id="' + a.id + '"></div>'));
        b.attr("ctype", a.type);
        b.attr("required", a.properties.required);
        b.attr("title", a.title);
        ...
        if ("view" == i.mode) {
            var d = $(b).find(".icon"),
            round = $(b).find(".element-box"),
            data = c,
            elem = $(b).find(".counter-elem");
            d.click(function(e){
                var exist = localStorage.getItem(data.id);
                if(exist == 'exist'){
                    alert('您已经点评过了');
                }else{
                    var f = {
                    ...
                    $.ajax({
                        ...
                        success: function(b) {
                            localStorage.setItem(data.id,'exist');
                            ...
                            round.css({
                                ...
                                backgroundColor: data.properties.color
                            });
                            round.find(".icon").css("color", data.css.backgroundColor);
                            round.find(".counter-number").css("color", data.css.backgroundColor);
                        }
                    })
                }
            })
        ...
        c(a, b) //链接
    }), i.bindAfterRenderEvent("m", function(a, b) {
        c(a, b)
    ...
    i.bindAfterRenderEvent("h", function(a, b) {
        "view" == i.mode && b.properties.url && $(a).click(function(a) { //链接
            var c = b.properties.url;
            isNaN(c) ? window.open(c) : eqxiu.pageScroll(c)
        })
        ...
        "view" == i.mode && $(a).find(".video_box").click(function() {
            if (b.properties.type == "v1") {
                ...
                $("#close_" + b.id).bind("click", function() {
                    ...
                    $("#mask_" + b.id).remove(), $("#close_" + b.id).remove();
...
eqxCommon = function() {
    ...
    c = function(a, b) {
        var c = $(a);
        if (b.trigger && b.trigger.receives && b.trigger.receives.length) { //触发 receives
...
eqShow.getShowCount = function(a) {
    ...
    if (a.obj.property.slideNumber) {
        var d = $('<div class="progress"></div>'), 
            e = $("<span></span>"), 
            f = $('<em class="page-tip" onchange="change()"></em>');
    ...
    function o(a, b) {
        ...
        for (a[b >>> 5] |= 128 << 24 - b % 32, a[(b + 65 >>> 9 << 4) + 15] = b, q = a.length, o = 0; q > o; o += 16) {
            for (c = y[0], d = y[1], e = y[2], f = y[3], g = y[4], p = 0; 80 > p; p += 1){
                ...
                if(20 > p){
                    h = x(v(c, 5), s(d, e, f), g, 1518500249, r[p]);
                }else if(40 > p){
                    h = x(v(c, 5), t(d, e, f), g, 1859775393, r[p]);
                }else if(60 > p){
                    h = x(v(c, 5), u(d, e, f), g, 2400959708, r[p]);
                }else{
                    h = x(v(c, 5), t(d, e, f), g, 3395469782, r[p]);
                }
                g = f;
                f = e;
                e = v(d, 30);
    ...
    function c(a, c) {//翻书翻页方式
        if(completeEffect(b(".z-current"))){
            E = "started";
    ...
    function d(a, c) {//翻书翻页方式
        E = "turning";
        W && W.obj.property.autoFlip && W.obj.property.autoFlipTime && m();
        c || (B ? (a = event, r = {
            x: a.touches[0].pageX - n.offset().left,
            y: a.touches[0].pageY - n.offset().top
        }) : r = {
        ...
        if (0 > s) {
            if (x) {
                ...
                o = b("#flip" + d);
                Z || (z = b(y).parent(".flip-mask").get(0).nextElementSibling && b(b(y).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) ? b(b(y).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) : A ? D.first().get(0) : !1);
                if (z) {
                    ...
                    i(z);
                    completeEffect(b(z)) || b("#audio_btn").css("opacity", 0);
                    if(t){
                        b(".z-current").css({
            ...
            o = b("#flip" + d);
            Z || (z = b(y).parent(".flip-mask").get(0).previousElementSibling && b(b(y).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) ? b(b(y).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) : A ? D.last().get(0) : !1);
            if(z){
                i(z);
                completeEffect(b(z)) || b("#audio_btn").css("opacity", 0);
                b(y).parent(".flip-mask").css({
    ...
    function e(a, b) {//翻书翻页方式
        if (!z){
            return E = "feeling", t = !1, u = !1, v = !1, w = !1, void (x = !0);
        }
        E = "leaving";
        var c, d, e, g;
        if(b){
            ...
            c = a.pageX - n.offset().left;
            d = a.pageY - n.offset().top;
        }
    ...
    function f(a) {
        if(t || u){
            H = n.width() - a.x;
            t ? I = Math.abs(n.height() - a.y) : u && (I = a.y);
            J = I / H;
            K = I / Math.sqrt(H * H + I * I);
            L = Math.sqrt(1 - K * K);
            M = Math.sqrt(H * H + I * I) / 2;
            N = M * J;
            O = Math.sqrt(N * N + M * M), P = O / J;
            G = 180 * Math.atan(J) / Math.PI > 0 ? 180 * Math.atan(J) / Math.PI : 0;
            Q = (n.width() - O) * L;
            R = (n.width() - O) * K * L;
            S = (n.width() - O) * (1 - K * K);
            if(Q >= 1){
                if(t){
                    ...
                    T = "0% 100% 0px";
                    U = "rotate(-" + (90 - G) + "deg) translateY(" + Q + "px)";
                    V = "rotate(" + (90 - G) + "deg) translateY(-" + R + "px) translateX(-" + S + "px)";
    ...
    function h() {
        var a = W.list;
        W.obj.property.autoFlip && W.obj.property.autoFlipTime && l();
        utilSound.pause();
        ...
        $ || eqShow.showProgressBar(W, b("#nr").find(".main-page"));
        $ = !0;
    }
    ...
    a.turnBook = function(a) {//翻书翻页方式
        W = a;
        if(W.obj.property.autoFlip && W.obj.property.autoFlipTime){
            X = W.obj.property.autoFlipTime;
            l();
        }
        
        A = W.obj.property.triggerLoop, b('<div class="turning"></div>').appendTo(".nr");
        b(".main-page").css({
            width: b(".nr").width() + "px",
        ...
        n.on(B ? "touchstart" : "mousedown", function(a) {
            ...
            if("started" == E || "turning" == E){
                d(a);
            }
        }).on(B ? "touchend" : "mouseup mouseleave", function(a) {
            Z = !1;
            if(b(".z-current").get(0)){
                if(0 == s){
                    x = !0;
                    return void (E = "feeling");
                }else{
                    return void ("turning" == E && e(a));
                }
            }else{
                return void 0;
            }
...
var eqxiu = function() {
    function a(a) { //链接
        if ("10" != m._scrollMode && a >= m._pageData[0].id) {
            B = !0;
        ...
        } else if ("10" != m._scrollMode || a < m._pageData[0].id) {
            // a = a+m._pageData.length-1;
            /*for(a,y=m._pageData[0].id;y>a;a = a+m._pageData.length-1)*/
            B = !0;
            for (var d, e = 0, f = m._pageData.length; f > e; e++){
                a == m._pageData[e].id && (d = m._pageData[e].num);
            }
            ...
            m.$activePage = $(h).parent(".main-page").get(0);
            g > d ? b() : d > g && c();
    ...
    function f() {
        m.$activePage = m._$pages.last().get(0);
        m._$pages.parent().find(".z-current").removeClass("z-current");
        m._$pages.last().addClass("z-current");
    }
    ...
    function f(a) {
        m._$pages.parent().find(".z-current").removeClass("z-current");
        if(a){
            m.$activePage = m._$pages.last().prev().get(0);
            m._$pages.last().prev().addClass("z-current");
        }else{
            m.$activePage = m._$pages.last().get(0);
            m._$pages.last().addClass("z-current");
        }
    ...
    var m, n, o, p, q, r, s, t, u, v, w, x, y, z = $(window), 
        ...
        N = function(a, b, c, e) {
            ...
            function h(a) {
                var b;
                if($("#inside_" + a, ".phone-view").length){
                    b = $("#inside_" + a, ".phone-view");
                }else{
                    b = $("#inside_" + a);
                }
                return b;
                ...
                if (Math.abs(H) > Math.abs(G) && completeEffect($(m.$currentPage))){
                    if (H > 0) {
                        ...
                        if(J || K){
                            ...
                            K = !1;
                            Z(!0);
                            _(!0, "bottom center", "translateY", s);

                        }else{
                            aa(!0, "translateY", s, H, m._scrollMode);
                        }
                    } else if (0 > H) {
                        if (m._isDisableFlipNextPage){
                            return;
                        }
                        if(!J || K){
                            J = !0;
            ...
            function T() {
                if (Math.abs(H) > Math.abs(G) && completeEffect($(m.$currentPage))) {
                    ...
                    m.$activePage.style.opacity = a.toFixed(1);
                    a.toFixed(3) <= 1 && g($(m.$activePage), "transform", "scale(" + a.toFixed(3) + ")");
                }
            }
                ...
                if (Math.abs(H) > Math.abs(G) && completeEffect($(m.$currentPage))) {
                    if (H > 0) {
                        ...
                        if(J || K){
                            ...
                            m.$activePage && (m.$activePage.classList.remove("z-active"), m.$activePage.classList.remove("z-move"));
                            Z(!0);
                            m.$activePage && m.$activePage.classList.contains("main-page") && ($(m.$activePage).addClass("z-active z-move"), $(m.$activePage).css({
                                zIndex: 0,
                                opacity: 1
                            }));
                            $(m.$currentPage).css({
                            ...
                            g($(m.$activePage), "transform", "translateY(0)");
                            g($(m.$currentPage), "transform-origin", "0% 0% 0px");
                        }
                    } else if (0 > H) {
                        if (m._isDisableFlipNextPage){
                            return;
                        ...
                        if(!J || K){
                            ...
                            m.$activePage && (m.$activePage.classList.remove("z-active"), m.$activePage.classList.remove("z-move"));
                            Z(!1);
                            m.$activePage && m.$activePage.classList.contains("main-page") && (m.$activePage.classList.add("z-active"), m.$activePage.classList.add("z-move"), $(m.$activePage).css({
                                zIndex: 0,
                                opacity: 1
                            }));
                            $(m.$currentPage).css({
            ...
            function aa(a, b, c, d, e) {
                if (m.$activePage) {
                    ...
                    if("1" == e || "3" == e){
                        g($(m.$currentPage), "transform", "scale(" + ((c - Math.abs(d)) / s).toFixed(3) + ")");
                    }else{
                        ("5" == e || "11" == e) && g($(m.$currentPage), "transform", b + "(" + d + "px)");
                    }
                }
            }
            ...
            window.playPageMusic = function(activePage) { //播放当页音乐
                //修改开始
                //nowPage的不足，第一遍循环获取是从2开始的
                activePage = activePage ? activePage : m.$activePage;
                var nowPage = activePage.firstElementChild.getAttribute('id');
                //滑动到的页码
                ...
                if (pageNum == 1) {
                    if(pageMusics[0]){
                        aud.setAttribute('src', pageMusics[0].url.substr(0, 5) == "index" ? pageMusics[0].url.split('index.php')[1] : ("Uploads/" + pageMusics[0].url))
                    }else{
                        aud.setAttribute('src', "");
                    }
                } else {
                    if(pageMusics[pageNum]){
                        aud.setAttribute('src', pageMusics[pageNum].url.substr(0, 5) == "index" ? pageMusics[pageNum].url.split('index.php')[1] : ("Uploads/" + pageMusics[pageNum].url));
                    }else{
                        aud.setAttribute('src', "");
                    }
                }
                ...
                //修改结束
                var zuihoupage = 'page' + tplCount;
                    //console.log(nowPage,zuihoupage);
                if(nowPage == zuihoupage){
                    $('#pageMusic').attr('src','')
                }
            ...
            function isAllowToScroll(index){
                ...
                for(var i = 0; i<currentData.length; i++){
                    if(typeof(currentData[i].properties.url) == 'undefined'){
                        if(currentData[i].content && currentData[i].content.indexOf("data=") > 0){
                            return !1;
                        }
                    }else{
                        var allnum = currentData[i].properties.url;
            ...
            if (c[0].elements && c[0].elements.length){
                for (var ea = 0; ea < c[0].elements.length; ea++) {
                    ...
                    eqxCommon.bindTrigger(fa, c[0].elements[ea]) //触发
                }
            }
            !
            function() {
            ...
            n = function(a) {
                da = !1;
                C && a && (a = event);
                m._isDisableFlipPage || (
                    m.$currentPage = m._$pages.filter(".z-current").get(0), 
                    B || (m.$activePage = null), 
                    m.$currentPage && completeEffect($(m.$currentPage)) && (
                        I = !0, 
                        J = !1, 
                        K = !0, 
                        G = 0, 
                            ...
                            $(m.$activePage).find("li").each(function(a) {
                                for (var c = 0; c < m._pageData[b - 1].elements.length; c++){
                                    if (m._pageData[b - 1].elements[c].id == parseInt($(this).attr("id").substring(7), 10)) {
                                        ...
                                        eqxCommon.bindTrigger(d, m._pageData[b - 1].elements[c]) //触发
                                    }
                                }
                            }) 
                        }
            ...
            $(document).on("flipend", function(a) {
                ...
                c = m._pageData, c[g - 1].elements && c[g - 1].elements.length && $.each(c[g - 1].elements, function(a, b) {
                    ...
                    $(m.$currentPage).trigger("hide"), utilSound.pause();
                    d.length && d.remove();
...
function(a, b) {
    ...
    function eqFreepage(a, b, c) {
        ...
        if (ad = 1, a.obj.property.lastPageId){
            ...
            $.ajax({
                ...
                success: function(c) {
                    if (!c.obj) {
                        ...
                        var f = JSON.parse(e);
                        f.num = a.list.length + 1, f.elements[2].properties.src = a.obj.cover; 
                        f.elements[1].content = f.elements[1].content.replace(/微课名称/, a.obj.name);
                    ...
                    "group1/M00/61/8A/yq0KA1T2vYSAEgo7AACovQVgHxk048.jpg" != a.obj.cover ? (l = JSON.parse(g), l.properties.src = a.obj.cover) : l = JSON.parse(h);
            ...
            "group1/M00/61/8A/yq0KA1T2vYSAEgo7AACovQVgHxk048.jpg" != a.obj.cover && (l.elements[2] = JSON.parse(f), l.elements[2].properties.src = a.obj.cover);
            l.elements[1].content = l.elements[1].content.replace(/微课名称/, a.obj.name);
            d(l, b, a);
        }
    }
    ...
    function parsePage(pages, data) {
        ...
        if (data.obj.music_url != 0) {
            window.onload = function audioAutoPlayTwo() {
        ...
        if(pageMusics[0]){
            if(pageMusics[0].url.substr(0, 5) == "index"){
                aud.setAttribute('src', pageMusics[0].url.split('index.php')[1]);
            }else{
                aud.setAttribute('src', "Uploads/" + pageMusics[0].url);
            }
        }else{
            aud.setAttribute('src', "");
        }
        ...
        //生成每个page的html
        for (var pageInfo = [], init = !1, pageNum = 1; pageNum <= pages.length; pageNum++) {
            ...
            if(pages.length > 1){
                var isHaveLinkUrl = !1;//判断有无链接去除箭头
            ...
            if (pageNum == pages.length) {//最后一页
                
                eqxiu.app($(".nr"), data.obj.pageMode, pages, data);//绑定预览窗口滑动翻页动画
                
                isMobile || $("img").on("dragstart", function(a) {
                    a.preventDefault()
                });
                if (!preview) {//统计阅览次数
        ...
        //$(function(){
            ...
            !PCcheck() && ($("#mainBox-left").hide(), $("#horizon-screen").hide());
            $(window).height() > 750 ? $(".miniPage").css({
            ...
            function setSound(elem, obj) {
                if (obj.sound) {
                    var c = $(elem), 
                        d = $("#media").get(0);
                    0 == obj.sound.src.indexOf("http://") ? obj.sound.src = obj.sound.src : obj.sound.src = PREFIX_FILE_HOST + obj.sound.src, utilSound.addAudio(elem, obj.sound.src), c.click(function() {
    ...
    function addEnabledClassToPageCtrl(a) {
        ...
        if(0 == d || 1 == d || 2 == d || 6 == d || 7 == d || 8 == d || 11 == d || 12 == d){
            b = !0;
        }else if(3 == d || 4 == d || 5 == d || 10 == d){
            c = !0;
        }

        setTimeout(function() {
            if(b){
                $(".ctrl_panel_dir .ctrl-up").addClass("enabled");
                e && $(".ctrl_panel_dir .ctrl-down").addClass("enabled");
            }else{
                if(c){
                    $(".ctrl_panel_dir .ctrl-left").addClass("enabled");
                    e && $(".ctrl_panel_dir .ctrl-right").addClass("enabled");
                }
            }
        }, 0)
    }
    ...
    function getCounterValues(a) {
        ...
        tanmuSceneId = a.obj.id;
        $.ajax({
            type: "GET",
            url: PREFIX_URL + "index.php?c=user&a=check&time=" + data.getTime(),
            success: function(data) {
                window.loginCode = data.code;
                window.loginImg = data.obj.headImg;
            }
        })
        $.ajax({
            type: "GET",
    ...
    function getRequestUrl() {
        ...
        if(scene.diyname){
            var diyname = scene.diyname;
        }else{
            var diyname = '';
        }
        return a += (/\?/.test(a) ? "&" : "?") + "time=" + (new Date).getTime() + '&diyname=' + diyname;
    }
    
    function combineUrl(a, b, c) {
        return  b && (a += "?1=1", a += /\?.*/.test(b) ? "&" + b.substring(1) : /\&.*/.test(b) ? b : "&" + b), 
                a += (/\?/.test(a) ? "&" : "?") + "ad=" + c, 
    ...
    function audioAutoPlay(id) {
        var audioAuto = document.getElementById(id);
    ...
    window.onload = audioAutoPlay('media');
    
    function parseJson(a, b) {
        isNewPreviewLocation || window.scene || (
            document.title = a.obj.name, 
            $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由微学宝免费移动微课应用自营销管家提供技术支持"), 
        ...
        return  a.obj.property && (a.obj.property = JSON.parse(a.obj.property) || {}), 
                ...
                c = a.list, 
                c.length <= 0 ? (alert("此微课不存在!"), void (window.location.href = your_demain)) : void appendLastPage(a, c, pageMode, preview, param, ad)
    }
    ...
    (param.indexOf("preview=preview") > 0 || window.preview || isNewPreviewLocation) && (preview = !0);
    ...
    if (!(mobilecheck() || tabletCheck() && window == window.top)) {
        var addElmentsForPc = function(a) {
            ...
            if(window != window.top){
                ...
                $("#horizon-screen").hide();
                $(".bg_white").hide();
                $(".phoneBox").attr("style", "margin-left: 4px");
                ...
                $.getScript(CLIENT_CDN + "common/js/qrcode.js", function() {
                    $.getScript(CLIENT_CDN + "common/js/jquery.qrcode.js", function() {
                        if(window.scene && 100 == window.scene.bizType){
                            ...
                            $("#con").before('<div id="support">技术支持 BY <a target="_blank" href=' + your_demain + '><img id="logoSmall" src="' + CLIENT_CDN + 'view/images/logobai.png"/></a></div></div>');
                        }
                ...
                $(".p-index").wrap('<div class = "phone_panel"></div>');
                $('<div id = "screen_panel"><span id="shuping" class="view_contrl">竖屏观看</span><span id="hengping" class="view_contrl">横屏观看</span></div>').appendTo($(".phone_panel"));
                $('<div class = "ctrl_panel"></div>').appendTo($(".phone_panel"));
                $('<div id="code"><span>扫我在手机上观看</span><div style="text-align: center;background:#fff;  margin-top: 3px;" id="codeImg"/><!--<div id="view_share" class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a></div>--></div><div class="otherOptions"><span class="vxueSquar"><a target="_blank" href="http://www.vxuebao.com/show/">查看其它案例</a></span><span class="vxuebaoDIY"><a target="_blank" href=' + your_demain + '>我也来制作</a></span></div>').appendTo($("#mainBox-left"));

                //setTimeout(function() { //判断移动端&&修改大小
                    if(window.scene && 100 == window.scene.bizType){
                        $(".phone_menubar").addClass("hypefolio");
                        if(!PCcheck()){
                            $('<a id = "pre_page" type = "button" class = "pre_btn btn btn1" onclick = "eqxiu.prePage()">\n    <span style="transform: rotateZ(90deg);display: inline-block;font-size: 36px;">&lt;</span>\n</a>').prependTo($(".ctrl_panel"));
                            $('<a id = "next_page" type = "button" class = "next_btn btn btn1" onclick = "eqxiu.nextPage()">\n    <span style="transform: rotateZ(90deg);display: inline-block;font-size: 36px;margin-top: 5px;">&gt;</span>\n</a>').appendTo($(".ctrl_panel"));
                        }else{
                        ...
                        if(!PCcheck()){
                            $('<a id="pre_page" type="button" class="pre_btn btn btn1" onclick = "eqxiu.prePage()">上一页</a>').prependTo($(".ctrl_panel"));
                            $('<a id="next_page" type="button" class="next_btn btn btn1" onclick = "eqxiu.nextPage()">下一页</a>').appendTo($(".ctrl_panel"));
                        }else{
                            $('<a id = "pre_page" type = "button" class = "pre_btn btn btn5" onclick = "eqxiu.prePage()"></a>').prependTo($(".ctrl_panel"));
                            $('<a id = "next_page" type = "button" class = "next_btn btn btn5" onclick = "eqxiu.nextPage()"></a>').appendTo($(".ctrl_panel"));
                        }
                    }
               // }, 100)
            }
    ...
    if (PCcheck()) {
        ...
        classReplace(".phoneBox .bottom", "bottom1", "bottom5");
        classReplace(".phoneBox .top", "top1", "top5");
        classReplace(".phoneBox .phone_menubar", "phone_menubar1", "phone_menubar5");
        classReplace(".phoneBox .scene_title_baner", "scene_title_baner1", "scene_title_baner5");
        classReplace(".phoneBox .scene_title", "scene_title1", "scene_title5");
        classReplace("#pre_btn", "btn11", "btn5");
        classReplace("#next_btn ", "btn11", "btn5");
    } else {
        /*alert("手机");*/
        ...
        classReplace(".phoneBox .top", "top5", "top1");
        classReplace(".phoneBox .phone_menubar", "phone_menubar5", "phone_menubar1");
        classReplace(".phoneBox .scene_title_baner", "scene_title_baner5", "scene_title_baner1");
        classReplace(".phoneBox .scene_title", "scene_title5", "scene_title1");
        classReplace(".phoneBox .bottom", "bottom5", "bottom1");
        classReplace("#pre_btn", "btn5", "btn11");
        classReplace("#next_btn", "btn5", "btn11");
    }
    jQuery.support.cors = !0, eqShow.bootstrap = function() { //接收后台数据
        var a = getRequestUrl();
        $.ajax({
            type: "GET",
            url: a,
            ...
            crossDomain: !0,
            success: function(data) {
                var newData = eval("(" + data.obj.property + ")")
                document.getElementById("zimu").style.display = "block";
                if (newData.iftanmu == true) {
                } else if (newData.iftanmu == false || newData.iftanmu == undefined) {
                    document.getElementById("zimu").style.display = "none";
                }
            }
        }).done(function(a) {
            a.obj = a.obj || window.scene, getCounterValues(a), parseJson(a, !1)
            $("#author .author>i").text(a.obj.userName);
            $("#author .readit>i").text(a.obj.showCount);
        })
        ...
        if (i || j) {
            var k, l = $(".container"), 
                m = l.width(), 
                n = l.height();
            k = Math.floor(10 * Math.min(document.documentElement.clientHeight / n, document.documentElement.clientWidth / m)) / 10;
            l.css("transform", "scale(" + k + ", " + k + ")");
        }
        var o = "";
    }
...
var _daKnet = {};
_daKnet.loadJs = function(a) {
    var b = document, 
    c = b.createElement("script"), 
    d = b.getElementsByTagName("script")[0];
    c.type = "text/javascript", c.async = !0, c.defer = !0, c.src = a, d.parentNode.insertBefore(c, d)
}
//异步生成百度地图
function asyncLoading() {
    var script = document.createElement("script");
    script.type = "text/javascript";
    script.src = "https://api.map.baidu.com/api?v=2.0&ak=AvwUoRnNEB5MVHYRpRdwFemgZa92M2fl&callback=initialize";
...
function initialize() {
    ...
    _daKnet.loadJs("http://da.knet.cn/boot_tracker.js?pid=2&v=1");
