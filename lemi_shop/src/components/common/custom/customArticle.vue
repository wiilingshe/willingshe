<template>
  <div class="customArticle">
    ...
    <div class="customArticle_wrap" :class="'articlesWrap' + articleObj.css_type" v-if="articleObj.css_type != 3">
      <div class="customArticle_item" :class="'articlesItem' + articleObj.css_type" v-for="j in articleObj.art_list"
           @click="goRoute(j.link)">
        <img :src="j.pic" class="customArticle_img" onerror="this.src=&quot;/static/img/pic_addfengmian.png&quot;"
             v-if="articleObj.css_type == 4||articleObj.css_type == 5">

        <div class="customArticle_img" :style="{'background-image':'url('+j.pic+')'}"
             v-if="articleObj.css_type == 2"></div>

        <img :src="articleObj.content[0].pic" class="customArticle_img"
             onerror="this.src=&quot;/static/img/pic_addfengmian.png&quot;"
             v-if="articleObj.css_type == 1&& articleObj.content[0] != undefined">
    ...
    <div class="customArticle_wrap" :class="'articlesWrap' + articleObj.css_type" v-if="articleObj.css_type == 3">
      <div class="customArticle_item" :class="'articlesItem' + articleObj.css_type" v-for="j in articleObj.art_list"
        ...
        <div class="customArticle_img" :style="{'background-image':'url('+j.pic+')'}">
          <!--<img :src="j.pic" class="" onerror="this.src=&quot;/static/img/pic_addfengmian.png&quot;">-->
        </div>
      </div>
    </div>
  </div>
