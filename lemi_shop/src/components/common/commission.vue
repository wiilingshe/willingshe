<template>
  <div id="commission">
    <div style="width: 100%;height: 8.35rem;overflow: scroll;-webkit-overflow-scrolling: touch;">
      <div class="tu" :style="{'padding-left':backtype==2?aaaa==0?'calc(50% - 2.1rem)':'calc(50% - 2.474rem)':'calc(50% - 2.474rem)'}">
        <img :src="selected">
      </div>
      <div class="tip">
