        ...
        <div style="background-color:#fff">
          ...
          <div class="main">
            <div>
              ...
              <div class="right">
                <input ref="account" type="username" name="" placeholder="输入账号名"/>
              </div>
            </div>
            <div>
              <div class="left">账号密码</div>
              <div class="right">
                <input ref="password" type="password" name="" placeholder="输入密码"/>
              </div>
            </div>
            <div>
              <div class="left">确认密码</div>
              <div class="right">
                <input ref="confirm" type="password" name="" placeholder="再次输入密码"/>
              </div>
            </div>
            <div>
              <div class="left">导师名称</div>
              <div class="right">
                <input ref="username" type="username" name="" placeholder="输入导师名称"/>
              </div>
            </div>
            <!--<div>-->
            ...
            <div>
              ...
              <div class="right">
                <input ref="trueName" type="username" name="" placeholder="输入真实姓名"/>
              </div>
            </div>
            <!--<div>-->
            ...
            <div>
              ...
              <div class="right">
                <input ref="phone" type="username" name="" placeholder="输入手机号码"/>
              </div>
            </div>
            <div>
              <div class="left">身份证号码</div>
              <div class="right">
                <input ref="idCard" type="username" name="" placeholder="输入身份证号码"/>
              </div>
            </div>
