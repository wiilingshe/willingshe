...
<script>
	...
	import orderArr from '@/components/publicPage/order/orderArr.vue'
	export default {
		data(){
			return{
				selected:'1',//默认选中
		...
		created(){
			...
			this.noShare();
			var url = '/shop-v1-order_lst.html?page='+this.pageNo1+'&type=series'
			...
			selected(val,oldval){
				if(val == 1){
					...
					if(this.status1==null){
						...
						var url = '/shop-v1-order_lst.html?page='+this.pageNo1+'&status='+this.status1+'&type=series'
					}
					this.getData('get',url).then(res => {
						if(res.status == 200){
							this.tipLoad = false;
					...
					this.pageNo2 = 1
					if(this.status2==null){
						var url2 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&type=video'
					}else{
						var url2 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&status='+this.status2+'&type=video'
					}
					...
					this.pageNo3 = 1
					if(this.status3==null){
						var url3 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&type=active'
					}else{
						var url3 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&status='+this.status3+'&type=active'
					}
					...
					this.pageNo4 = 1
					if(this.status4==null){
						var url4 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&type=comboset'
					}else{
						var url4 = '/shop-v1-order_lst.html?page='+this.pageNo2+'&status='+this.status4+'&type=comboset'
					}
