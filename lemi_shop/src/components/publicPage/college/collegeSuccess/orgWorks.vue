	...
	<div class="box allxueyuanke">
		...
		<mt-tab-container v-model="selected">
		  <mt-tab-container-item id="1">
		  	<div class="keheight">
			    <div class="video">
			    	<div class="video_box" v-for="j in arr2" @click="details(j)">
			    		<div class="left">
			    		...
			    		<div class="right">
			    			...
			    			<div>{{j.status == 0 ?'默认':j.status == 1?'审核中':j.status == 2?'审核通过':'审核失败'}}</div>
			    			<div></div>
			    		</div>
			    	</div>
			    </div>
		  ...
		  <mt-tab-container-item id="2">
		  	<div class="keheight">
		      <div class="video">
		      	<div class="video_box" v-for="i in arr1" @click="details(i)">
		    		<div class="left">
...
<script>
	...
	export default {
		...
		created(){
			...
			this.postData('post','/shop-v1-shop_get_org_videoseries_info.html',{"type":"series"}).then(res => {
