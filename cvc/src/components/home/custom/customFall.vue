<template>
  <div class="customFall">
    ...
    <div class="customFall_item" v-for="i in fullObj.content">
      <img :src="i" alt="" class="customFall_img" onerror="this.src=&quot;/static/img/onerr2.png&quot;" @load="imgLoad()" @click="">
    </div>
    <!--大图预览-->
        ...
        <mt-swipe :auto="0" :defaultIndex="defaultIndex">
          <mt-swipe-item  v-for="(item,index) in bigImg" :key="index">
            <div style="display: table;width:100%;height: 100%;">
              <div style="display: table-cell;width:100%;vertical-align: middle;height: 100%;text-align: center" @click="closeImg()">
                <img  class="customFall_bigimg" :src="item.src" onerror="this.src=&quot;/static/img/onerr2.png&quot;" @click="stopClick($event)" @load="bigLoad($event)">
              </div>
            </div>
          </mt-swipe-item>
        </mt-swipe>
