<template>
  <div class="customCompany">
    ...
    <div class="customCompany_content-wrap company3" v-if="companyArr.css_type < 4">
      <img :src="companyArr.content[1].logo"  onerror="this.src=&quot;/static/img/onerr2.png&quot;" class="customCompany_content-topimg" v-if="companyArr.css_type == 2">
      ...
      <img :src="companyArr.content[1].logo" onerror="this.src=&quot;/static/img/onerr2.png&quot;" class="customCompany_content-bottomimg" v-if="companyArr.css_type == 3">
    </div>
    <!--样式4-->
    <div class="customCompany_content-wrap company4" v-if="companyArr.css_type == 4">
      ...
      <div class="customCompany_content-item" v-for="(i,index) in contentArr">
        <div class="customCompany_content-imgwrap" v-if="i.content_postiton == 1">
          <img :src="i.pic" onerror="this.src=&quot;/static/img/onerr2.png&quot;" class="customCompany_content-sideimg">
        </div>
