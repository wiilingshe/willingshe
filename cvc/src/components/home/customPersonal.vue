...
<!--未组件化部分-->
    ...
    <div class="cPersonal_excellence" style="" :class=" 'custom'+i.sorting" v-for="i in recommendArr">
      <div class="cPersonal_excellence-wrap">
        ...
        <div class="cPersonal_excellence-item" v-for="(j,index) in i.shop_list" @click="goRoute(j.link)" v-if="index<=3">
          <img :src="j.face" class="cPersonal_excellence-img" @error="j.face = j.face == ''? '/static/img/onerr3.jpg':'/static/img/onerr1.png';" >
      ...
      <div class="cPersonal_mentor-wrap">
        ...
        <div class="cPersonal_mentor-list">
          <div class="cPersonal_mentor-item" v-for=" (j,index) in i.shop_list" @click="goRoute(j.link)" v-if="index<=5">
            <img :src="j.face" class="cPersonal_mentor-img" @error="j.face = j.face == ''? '/static/img/onerr3.jpg':'/static/img/onerr1.png';">
    ...
    <div class="cPersonal_make" style="" :class=" 'custom'+i.sorting" v-for="i in makeArr">
      ...
      <div class="cPersonal_make-wrap make3" v-if="i.css_type == 3">
        ...
        <div class="cPersonal_make-btn" @click="postMake(i.css_type)" style="background-color: #0086b3">
          提交
        </div>
      </div>
           ...
           <span class="cPersonal_make-close" @click="closeTable()">
            <i class="icon iconfont icon-guanbi"></i>
              ...
              <i class="icon iconfont icon-kechengbiao"></i>
                    ...
                    <div class="cPersonal_make-kbtn" @click="postMake(i.css_type)">
                      提交
                    </div>
                  </div>
                </div>
      ...
      <div class="cPersonal_video-wrap">
        <div style="height: 100%;position: relative">
          <div class="cPersonal_video-cover" @click="postVideo()" v-if="videoIs">
            <img class="cPersonal_video-coverimg" :src="i.content[0].pic" onerror="this.src=&quot;/static/img/onerr2.png&quot;">
...
<script>
  ...
  import customAdv from '@/components/home/custom/customAdv2';
...
//        预约时间
        ...
        this.postData('post','/shop-v1-custom_personal_website.html',{id:Id,type_id:typeId,page_id:pageId}).then(res => {
          if(res.status == 200){
              res.data
...
//            人员列表
            if(Oitem.type == 'staff_list'){
              ...
              if(Oitem.background_type == 2){
                $('.custom'+i+'>.cPersonal_mentor-wrap').css({'background':'url('+Oitem.content[0].bg_img +') no-repeat 0 0','background-size':'cover'});
              }
            }
//            内容
...
//            预约
            if(Oitem.type == 'make'){
              ...
              $('.custom'+i+' .cPersonal_make-title').css({'text-align':titCenter,'color':Oitem.title_color,'font-size':titleSize});
              ...
              if(Oitem.background_type == 2){
                $('.custom'+i+'>.cPersonal_make-wrap').css({'background':'url('+Oitem.content[0].bg_img +') no-repeat 0 0','background-size':'cover'});
              }
              if(Oitem.css_type == 2){
...
//              转化为字符串
              ...
              $('.custom'+i+' .cPersonal_excellence-title').css({'text-align':titCenter,'color':Oitem.title_color,'font-size':titleSize});
              ...
              if(Oitem.background_type == 2){
                $('.custom'+i+'>.cPersonal_excellence-wrap').css({'background':'url('+Oitem.content[0].bg_img +') no-repeat 0 0','background-size':'cover'});
              }
            }
          }
        },
        ...
        postMake(type){
          ...
          if(this.isMake[0].is && name ==''){
            ...
            this.postData('post','/shop-v1-custom_do_meeting.html',{shop_id:this.shopId,name:name,phone:phone,msg:msg,meeting_time:this.timePost}).then(res => {
              if(res.status ==200){
                if(res.data.status == 1){
                  if(type == 1){
                    this.tableShow = false;
    ...
    components:{customCompany,customRoasting,customClass,customTitle,customArticle,customAdv,customFall,customSingle,customSeries},
    }
</script>
