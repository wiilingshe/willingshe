  ...
  <div class="bindPhone">
    <div class="bindPhone_content" v-if="phonetype == 1">
      ...
      <div class="bindPhone_content-item bindPhone_phone">
        <label>
          <div class="bindPhone_content-left">
            <span class="bindPhone_phone-headnum">手机号码</span>
      ...
      <div class="bindPhone_content-item bindPhone_code">
        <div class="bindPhone_content-left">
          <span class="bindPhone_phone-headnum">图形验证码</span>
      ...
      <div class="bindPhone_content-item bindPhone_sms">
        <label>
          <div class="bindPhone_content-left">
            <span class="bindPhone_phone-headnum">短信验证码</span>
...
//            console.log(this.phonetype);
            ...
            // this.remindis = true;
            // $('.bindPhone_reminding').html("请输入正确的验证码");
            Toast({
              message: '请输入正确的图形验证码',
              duration: 2500
            });
