	...
	<div class="collegeApply_box" style="background-color:#fff">
		<div v-show="xieyi" style="height:100%;">
			...
			<div id="centext" style="border:0">
				...
				<div>
					<label for="radio" v-show="input"><i class="iconfont icon-check" style="color:#1c252c;position: relative;left: 0.3rem;"></i></label>
				    <label for="radio" v-show="!input"><i class="iconfont icon-check" style="position: relative;left: 0.3rem;"></i></label>
					...
					<u style="font-size:0.24rem;" @click="xieyi1()"><相关协议></u>
				</div>
			</div> 
...
<script>
	...
	export default {
		...
		methods:{
			...
			setApply(){
				/*console.log(this.pic_business,this.pic_positive,this.pic_back)*/
